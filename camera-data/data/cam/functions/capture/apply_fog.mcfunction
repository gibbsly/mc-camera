...
execute store result storage cam:main color.r int 1 run scoreboard players operation color= cam.main += fog_color= cam.main
...
scoreboard players operation fog_color= cam.main *= rd= cam.main
scoreboard players operation fog_color= cam.main /= fog_atten= cam.main
execute store result storage cam:main color.g int 1 run scoreboard players operation color= cam.main += fog_color= cam.main
...
scoreboard players operation fog_color= cam.main *= rd= cam.main
scoreboard players operation fog_color= cam.main /= fog_atten= cam.main
execute store result storage cam:main color.b int 1 run scoreboard players operation color= cam.main += fog_color= cam.main