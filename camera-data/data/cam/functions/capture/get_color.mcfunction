execute store result score rx= cam.main store result score rz= cam.main run data get storage cam:main color.r
...
execute if score rz= cam.main matches 00 positioned 0 0 00 run function cam:capture/get_color/row
execute if score rz= cam.main matches 01 positioned 0 0 01 run function cam:capture/get_color/row
execute if score rz= cam.main matches 02 positioned 0 0 02 run function cam:capture/get_color/row
execute if score rz= cam.main matches 03 positioned 0 0 03 run function cam:capture/get_color/row
execute if score rz= cam.main matches 04 positioned 0 0 04 run function cam:capture/get_color/row
execute if score rz= cam.main matches 05 positioned 0 0 05 run function cam:capture/get_color/row
execute if score rz= cam.main matches 06 positioned 0 0 06 run function cam:capture/get_color/row
execute if score rz= cam.main matches 07 positioned 0 0 07 run function cam:capture/get_color/row
execute if score rz= cam.main matches 08 positioned 0 0 08 run function cam:capture/get_color/row
execute if score rz= cam.main matches 09 positioned 0 0 09 run function cam:capture/get_color/row
execute if score rz= cam.main matches 10 positioned 0 0 10 run function cam:capture/get_color/row
execute if score rz= cam.main matches 11 positioned 0 0 11 run function cam:capture/get_color/row
execute if score rz= cam.main matches 12 positioned 0 0 12 run function cam:capture/get_color/row
execute if score rz= cam.main matches 13 positioned 0 0 13 run function cam:capture/get_color/row
execute if score rz= cam.main matches 14 positioned 0 0 14 run function cam:capture/get_color/row
execute if score rz= cam.main matches 15 positioned 0 0 15 run function cam:capture/get_color/row
