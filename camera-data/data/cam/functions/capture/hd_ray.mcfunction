...
execute if score hdd= cam.main matches 0 if score water= cam.main matches 0 positioned ^ ^ ^0.75 positioned ~-0.5 ~-0.5 ~-0.5 store result score nearby= cam.main if predicate cam:nearby
execute if score hdd= cam.main matches 0 if score water= cam.main matches 1 positioned ^ ^ ^0.75 positioned ~-0.5 ~-0.5 ~-0.5 store result score nearby= cam.main if predicate cam:capture_nearby

execute if block ~ ~ ~ #cam:capture run scoreboard players set dist= cam.main 4096
