...
scoreboard players operation sky_rd= cam.main %= #16 cam.main
scoreboard players operation sky_gd= cam.main %= #16 cam.main
scoreboard players operation sky_bd= cam.main %= #16 cam.main
